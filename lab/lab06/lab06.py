...
class BankAccount:
    ...
    def __init__(self, account_holder):
        ...
        self.transactions = []  # 添加交易列表
        self.transaction_count = 0  # 交易计数器
    ...
    def deposit(self, amount):
        ...
        # 创建交易记录，即使余额没有变化也要记录
        transaction = Transaction(self.transaction_count, before_balance, self.balance)
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            # 资金不足，但还是要记录交易
            transaction = Transaction(self.transaction_count, before_balance, before_balance)
            self.transactions.append(transaction)
            self.transaction_count += 1
